...
/** @addtogroup N9H30_SC_Driver SC Driver
  @{
*/

/** @addtogroup N9H30_SC_EXPORTED_CONSTANTS SC Exported Constants
  @{
*/
#define SC_INTERFACE_NUM        2                /*!< Smartcard interface numbers */ /* N9H30 series has only one SC interface */
...
/*@}*/ /* end of group N9H30_SC_EXPORTED_CONSTANTS */


/** @addtogroup N9H30_SC_EXPORTED_FUNCTIONS SC Exported Functions
  @{
*/
...
/*@}*/ /* end of group N9H30_SC_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N9H30_SC_Driver */
